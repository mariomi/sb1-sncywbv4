...
const copy: Record<Language, {
  ...
  it: {
    ...
    privacyBefore: 'Ho letto e accetto la', privacyAfter: 'e il trattamento dei miei dati personali.', privacyError: 'Accetta la privacy policy per continuare.',
  ...
  en: {
    ...
    privacyBefore: 'I have read and accept the', privacyAfter: 'and the processing of my personal data.', privacyError: 'Please accept the privacy policy to continue.',
  ...
  fr: {
    ...
    privacyBefore: 'J’ai lu et j’accepte la', privacyAfter: 'ainsi que le traitement de mes données personnelles.', privacyError: 'Veuillez accepter la politique de confidentialité.',
  ...
  de: {
    ...
    privacyBefore: 'Ich habe die', privacyAfter: 'gelesen und stimme der Verarbeitung meiner personenbezogenen Daten zu.', privacyError: 'Bitte akzeptieren Sie die Datenschutzerklärung.',
  ...
  es: {
    ...
    privacyBefore: 'He leído y acepto la', privacyAfter: 'y el tratamiento de mis datos personales.', privacyError: 'Acepta la política de privacidad para continuar.',
        ...
        <motion.section className="relative mx-auto h-[34svh] min-h-[280px] max-w-[1480px] overflow-hidden border-x border-venetian-brown/15 dark:border-white/10 sm:h-[46vh] sm:min-h-[420px]" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }}>
          ...
          <div className="relative flex h-full items-end px-5 py-8 sm:px-10 sm:py-12 lg:px-16">
            <div className="max-w-3xl">
              ...
              <h1 className="font-serif text-5xl font-semibold leading-[0.86] text-white sm:text-8xl">{text.title}</h1>
        ...
        <div className="mx-auto max-w-[1480px] px-4 py-12 sm:px-7 sm:py-20 lg:px-10">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <motion.section className="order-1 border-t border-venetian-brown pt-7 dark:border-white" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h2 className="mb-7 font-serif text-4xl font-semibold text-venetian-brown dark:text-white sm:text-6xl">{text.formTitle}</h2>
