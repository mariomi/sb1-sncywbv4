...
const privacyCopy: Record<Language, PrivacyCopy> = {
  it: {
    ...
    dataTitle: 'Dati trattati e finalità', dataItems: ['Prenotazioni e lista d’attesa: nome, email, telefono, data, ora, numero di ospiti, stato e informazioni facoltative, per registrare e gestire la richiesta, inviare conferme e promemoria e fornire assistenza.', 'WhatsApp di servizio facoltativo: se selezioni l’opzione dedicata, il numero di telefono e i dati essenziali della prenotazione sono usati per conferme, aggiornamenti e promemoria. Richieste speciali e informazioni sulle allergie non vengono incluse nei modelli WhatsApp.', 'Contatti: nome, email, oggetto e messaggio, per rispondere alla richiesta.', 'Dati tecnici e di sicurezza: orari delle richieste, indirizzo di rete, log e informazioni sul dispositivo, nella misura necessaria a proteggere il sito, prevenire abusi e diagnosticare errori.', 'Dati di navigazione e campagna: pagine, interazioni e parametri promozionali, soltanto dopo il consenso alla categoria corrispondente, per misurazione e pubblicità.', 'Consenso marketing: scelta facoltativa e relativa prova, per eventuali comunicazioni su offerte, eventi e novità.'],
    basisTitle: 'Basi giuridiche e conferimento', basisItems: ['Esecuzione di misure richieste dall’utente e del servizio di prenotazione (art. 6.1.b GDPR).', 'Obblighi di legge applicabili al gestore (art. 6.1.c GDPR).', 'Legittimo interesse alla sicurezza, continuità del servizio e tutela dei diritti, bilanciato con i diritti degli utenti (art. 6.1.f GDPR).', 'Consenso revocabile per WhatsApp di servizio, analisi, pubblicità e comunicazioni marketing facoltative (art. 6.1.a GDPR).'],
    ...
    providerTitle: 'Destinatari e trasferimenti', providerText: 'I dati possono essere trattati, per quanto necessario, da personale autorizzato e fornitori contrattualmente incaricati: Supabase per database e autenticazione, Resend per email transazionali, Netlify per hosting e distribuzione, Meta Platforms tramite WhatsApp Business Platform per i messaggi di servizio richiesti, fornitori di assistenza tecnica e, solo con consenso, Google e Meta per misurazione o pubblicità.', transferText: 'Alcuni fornitori possono trattare dati fuori dallo Spazio economico europeo. In tal caso il trasferimento deve basarsi su una decisione di adeguatezza o su garanzie appropriate, incluse le clausole contrattuali standard, secondo le condizioni applicabili del fornitore e le verifiche del titolare.',
    retentionTitle: 'Conservazione', retentionItems: ['Prenotazioni e comunicazioni sono conservate per gestire il servizio e, successivamente, solo finché necessario per obblighi di legge, contestazioni o tutela dei diritti.', 'I messaggi di contatto sono conservati fino alla gestione della richiesta e all’eventuale seguito compatibile.', 'I consensi marketing e WhatsApp valgono fino alla revoca; i messaggi WhatsApp di servizio possono essere interrotti rispondendo STOP. Le preferenze cookie vengono richieste nuovamente dopo sei mesi o quando cambia in modo rilevante il trattamento.', 'I log tecnici seguono i tempi strettamente necessari alla sicurezza e quelli operativi dei fornitori. Al termine, i dati sono cancellati o anonimizzati quando possibile.'],
    ...
    choicesTitle: 'Gestire le scelte', choicesText: 'Rifiutare gli strumenti facoltativi o WhatsApp non impedisce di consultare il sito o prenotare. Le categorie cookie e l’opzione WhatsApp sono disattivate per impostazione predefinita; puoi interrompere i messaggi WhatsApp rispondendo STOP.', settings: 'Rivedi le scelte cookie', legal: 'Note legali e condizioni di prenotazione',
  },
  en: {
    ...
    dataTitle: 'Data and purposes', dataItems: ['Bookings and waitlist: name, email, phone, date, time, party size, status and optional details, to register and manage the request, send confirmations and reminders, and provide assistance.', 'Optional WhatsApp service messages: if you select the separate option, the phone number and essential booking details are used for confirmations, updates and reminders. Special requests and allergy information are not included in WhatsApp templates.', 'Contact requests: name, email, subject and message, to answer the request.', 'Technical and security data: request times, network address, logs and device information, as needed to secure the service, prevent abuse and diagnose errors.', 'Browsing and campaign data: pages, interactions and promotional parameters, only after consent to the relevant category, for measurement and advertising.', 'Marketing choice: the optional preference and its record, for possible news about offers and events.'],
    basisTitle: 'Legal bases and required data', basisItems: ['Steps requested by the user and performance of the booking service (Article 6(1)(b) GDPR).', 'Legal obligations applying to the operator (Article 6(1)(c) GDPR).', 'Legitimate interests in security, service continuity and protection of legal rights, balanced against users’ rights (Article 6(1)(f) GDPR).', 'Withdrawable consent for optional WhatsApp service messages, analytics, advertising and marketing communications (Article 6(1)(a) GDPR).'],
    ...
    providerTitle: 'Recipients and transfers', providerText: 'Where necessary, data may be handled by authorised staff and contracted providers: Supabase for database and authentication, Resend for transactional email, Netlify for hosting and delivery, Meta Platforms through the WhatsApp Business Platform for requested service messages, technical support providers and, with consent only, Google and Meta for measurement or advertising.', transferText: 'Some providers may process data outside the European Economic Area. Transfers then rely on an adequacy decision or appropriate safeguards, including standard contractual clauses, as declared by the provider and assessed by the controller.',
    retentionTitle: 'Retention', retentionItems: ['Booking records and communications are kept to provide the service and then only for as long as needed for legal duties, disputes or protection of rights.', 'Contact messages are kept until the request and any compatible follow-up have been handled.', 'Marketing and WhatsApp consents last until withdrawal; WhatsApp service messages can be stopped by replying STOP. Cookie choices are requested again after six months or when processing changes materially.', 'Technical logs follow security needs and providers’ operational retention. Data is then deleted or anonymised where possible.'],
    ...
    choicesTitle: 'Manage choices', choicesText: 'Rejecting optional tools or WhatsApp does not prevent browsing or booking. Cookie categories and the WhatsApp option are off by default; WhatsApp messages can be stopped by replying STOP.', settings: 'Review cookie choices', legal: 'Legal notice and booking terms',
  },
  fr: {
    ...
    dataTitle: 'Données et finalités', dataItems: ['Réservation et liste d’attente : identité, coordonnées, date, heure, nombre de personnes, statut et informations facultatives, pour gérer la demande, envoyer confirmations et rappels et fournir une assistance.', 'Messages de service WhatsApp facultatifs : si vous choisissez l’option dédiée, le numéro de téléphone et les informations essentielles de la réservation servent aux confirmations, mises à jour et rappels. Les demandes spéciales et informations sur les allergies ne figurent pas dans les modèles WhatsApp.', 'Demandes de contact : nom, e-mail, objet et message, pour répondre.', 'Données techniques et de sécurité : horaires, adresse réseau, journaux et appareil, pour protéger le service, prévenir les abus et diagnostiquer les erreurs.', 'Navigation et campagne : pages, interactions et paramètres promotionnels, uniquement après consentement, pour la mesure et la publicité.', 'Choix marketing facultatif et sa preuve, pour d’éventuelles communications sur offres et événements.'],
    basisTitle: 'Bases juridiques et fourniture', basisItems: ['Mesures demandées et exécution du service de réservation (art. 6.1.b RGPD).', 'Obligations légales de l’exploitant (art. 6.1.c RGPD).', 'Intérêt légitime à la sécurité, à la continuité et à la défense des droits (art. 6.1.f RGPD).', 'Consentement révocable pour les messages de service WhatsApp, l’analyse, la publicité et le marketing facultatifs (art. 6.1.a RGPD).'],
    ...
    providerTitle: 'Destinataires et transferts', providerText: 'Les données peuvent être traitées par le personnel autorisé et les prestataires nécessaires : Supabase, Resend, Netlify, Meta Platforms via WhatsApp Business Platform pour les messages de service demandés, assistance technique et, uniquement avec consentement, Google et Meta pour la mesure ou la publicité.', transferText: 'Certains prestataires peuvent traiter les données hors EEE sur la base d’une décision d’adéquation ou de garanties appropriées, notamment les clauses contractuelles types.',
    retentionTitle: 'Conservation', retentionItems: ['Les réservations et communications sont conservées pour le service puis uniquement selon les obligations légales, litiges ou défense des droits.', 'Les messages sont conservés jusqu’au traitement de la demande et de son suivi compatible.', 'Les consentements marketing et WhatsApp valent jusqu’au retrait ; les messages de service WhatsApp peuvent être arrêtés en répondant STOP. Les choix cookie sont redemandés après six mois ou en cas de changement important.', 'Les journaux techniques suivent les besoins de sécurité, puis les données sont supprimées ou anonymisées si possible.'],
    ...
    choicesTitle: 'Gérer les choix', choicesText: 'Refuser les outils facultatifs ou WhatsApp n’empêche ni la navigation ni la réservation. Les catégories cookie et l’option WhatsApp sont désactivées par défaut ; les messages WhatsApp peuvent être arrêtés en répondant STOP.', settings: 'Revoir les choix cookie', legal: 'Mentions légales et conditions de réservation',
  },
  de: {
    ...
    dataTitle: 'Daten und Zwecke', dataItems: ['Reservierung und Warteliste: Name, E-Mail, Telefon, Datum, Uhrzeit, Personenzahl, Status und freiwillige Angaben zur Verwaltung, Bestätigung, Erinnerung und Unterstützung.', 'Optionale WhatsApp-Servicenachrichten: Wenn Sie die separate Option auswählen, werden Telefonnummer und wesentliche Reservierungsdaten für Bestätigungen, Aktualisierungen und Erinnerungen verwendet. Besondere Wünsche und Allergiehinweise werden nicht in WhatsApp-Vorlagen aufgenommen.', 'Kontakt: Name, E-Mail, Betreff und Nachricht zur Beantwortung.', 'Technik und Sicherheit: Anfragezeiten, Netzwerkadresse, Protokolle und Gerätedaten zum Schutz, zur Missbrauchsprävention und Fehlerdiagnose.', 'Nutzung und Kampagnen: Seiten, Interaktionen und Werbeparameter nur nach Einwilligung für Messung und Werbung.', 'Freiwillige Marketingauswahl und Nachweis für mögliche Mitteilungen zu Angeboten und Veranstaltungen.'],
    basisTitle: 'Rechtsgrundlagen und Bereitstellung', basisItems: ['Angeforderte Maßnahmen und Reservierungsleistung (Art. 6 Abs. 1 lit. b DSGVO).', 'Gesetzliche Pflichten (Art. 6 Abs. 1 lit. c DSGVO).', 'Berechtigte Interessen an Sicherheit, Kontinuität und Rechtsverteidigung (Art. 6 Abs. 1 lit. f DSGVO).', 'Widerrufliche Einwilligung für optionale WhatsApp-Servicenachrichten, Analyse, Werbung und Marketing (Art. 6 Abs. 1 lit. a DSGVO).'],
    ...
    providerTitle: 'Empfänger und Übermittlungen', providerText: 'Daten können durch befugtes Personal und notwendige Auftragsverarbeiter verarbeitet werden: Supabase, Resend, Netlify, Meta Platforms über die WhatsApp Business Platform für angeforderte Servicenachrichten, technischer Support und nur mit Einwilligung Google und Meta für Messung oder Werbung.', transferText: 'Einige Anbieter verarbeiten möglicherweise außerhalb des EWR. Dann gelten Angemessenheitsbeschlüsse oder geeignete Garantien, insbesondere Standardvertragsklauseln.',
    retentionTitle: 'Speicherdauer', retentionItems: ['Reservierungen und Kommunikation bleiben für die Leistung und danach nur wegen gesetzlicher Pflichten, Streitigkeiten oder Rechtsverteidigung gespeichert.', 'Kontaktanfragen bis zur Erledigung und einem damit vereinbaren Folgekontakt.', 'Marketing- und WhatsApp-Einwilligungen gelten bis zum Widerruf; WhatsApp-Servicenachrichten können mit der Antwort STOP beendet werden. Die Cookie-Auswahl gilt sechs Monate oder bis zu einer wesentlichen Änderung.', 'Technische Protokolle nach Sicherheitsbedarf; anschließend Löschung oder Anonymisierung, soweit möglich.'],
    ...
    choicesTitle: 'Auswahl verwalten', choicesText: 'Die Ablehnung optionaler Tools oder von WhatsApp verhindert weder Nutzung noch Reservierung. Cookie-Kategorien und die WhatsApp-Option sind standardmäßig aus; WhatsApp-Nachrichten können mit der Antwort STOP beendet werden.', settings: 'Cookie-Auswahl prüfen', legal: 'Impressum und Reservierungsbedingungen',
  },
  es: {
    ...
    dataTitle: 'Datos y finalidades', dataItems: ['Reservas y lista de espera: nombre, email, teléfono, fecha, hora, personas, estado y datos opcionales, para gestionar, confirmar, recordar y asistir.', 'Mensajes de servicio opcionales por WhatsApp: si eliges la opción específica, el teléfono y los datos esenciales de la reserva se usan para confirmaciones, actualizaciones y recordatorios. Las peticiones especiales y la información sobre alergias no se incluyen en las plantillas de WhatsApp.', 'Contacto: nombre, email, asunto y mensaje para responder.', 'Datos técnicos y de seguridad: horarios, dirección de red, registros y dispositivo para proteger el servicio, prevenir abusos y diagnosticar errores.', 'Navegación y campañas: páginas, interacciones y parámetros promocionales, solo con consentimiento, para medición y publicidad.', 'Elección opcional de marketing y su prueba para posibles comunicaciones sobre ofertas y eventos.'],
    basisTitle: 'Bases jurídicas y entrega de datos', basisItems: ['Medidas solicitadas y prestación de la reserva (art. 6.1.b RGPD).', 'Obligaciones legales del operador (art. 6.1.c RGPD).', 'Interés legítimo en seguridad, continuidad y defensa de derechos (art. 6.1.f RGPD).', 'Consentimiento revocable para mensajes de servicio opcionales por WhatsApp, análisis, publicidad y marketing (art. 6.1.a RGPD).'],
    ...
    providerTitle: 'Destinatarios y transferencias', providerText: 'Los datos pueden ser tratados por personal autorizado y proveedores necesarios: Supabase, Resend, Netlify, Meta Platforms mediante WhatsApp Business Platform para los mensajes de servicio solicitados, asistencia técnica y, solo con consentimiento, Google y Meta para medición o publicidad.', transferText: 'Algunos proveedores pueden tratar datos fuera del EEE mediante una decisión de adecuación o garantías apropiadas, incluidas cláusulas contractuales tipo.',
    retentionTitle: 'Conservación', retentionItems: ['Reservas y comunicaciones se guardan para el servicio y después solo por obligaciones legales, disputas o defensa de derechos.', 'Los mensajes se guardan hasta atender la solicitud y su seguimiento compatible.', 'Los consentimientos de marketing y WhatsApp duran hasta su retirada; los mensajes de servicio por WhatsApp pueden detenerse respondiendo STOP. Las elecciones de cookies se solicitan de nuevo tras seis meses o cambios importantes.', 'Los registros técnicos siguen las necesidades de seguridad; después se borran o anonimizan cuando es posible.'],
    ...
    choicesTitle: 'Gestionar elecciones', choicesText: 'Rechazar herramientas opcionales o WhatsApp no impide navegar ni reservar. Las categorías de cookies y la opción de WhatsApp están desactivadas por defecto; los mensajes de WhatsApp pueden detenerse respondiendo STOP.', settings: 'Revisar preferencias de cookies', legal: 'Aviso legal y condiciones de reserva',
  },
};
      ...
      <main className="min-h-screen bg-venetian-sandstone pb-20 pt-[84px] dark:bg-venetian-brown">
        <article className="mx-auto max-w-5xl px-4 py-16 sm:px-7 sm:py-24">
          <div className="border-t border-venetian-brown pt-7 dark:border-white">
            ...
            <h1 className="max-w-[11ch] font-serif text-6xl font-black uppercase leading-[0.76] tracking-[-0.05em] text-venetian-brown sm:text-8xl dark:text-white">{copy.title}</h1>
