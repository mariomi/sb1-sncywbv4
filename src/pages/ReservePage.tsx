...
export function ReservePage() {
  ...
  useEffect(() => {
    ...
    if (selectedSlot && (!selectedSlot.available || selectedSlot.remainingCapacity < formData.guests) && !(waitlistEnabled && showWaitlistBanner)) {
      setFormData((previous) => ({ ...previous, time: '' }));
    }
  }, [formData.guests, formData.time, showWaitlistBanner, timeSlots, waitlistEnabled]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const reservation = await createReservation(validation.data, language);
                              ...
                              return (
                                <motion.button
                                  ...
                                  onClick={() => {
                                    ...
                                    setShowWaitlistBanner(!canFit && waitlistEnabled);
                                    setWaitlistSuccess(false);
                                  }}
