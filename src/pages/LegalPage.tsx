...
const legalCopy: Record<Language, LegalCopy> = {
  it: {
    ...
    cancellationText: 'La prenotazione può essere cancellata gratuitamente, prima dell’orario prenotato, tramite il link personale ricevuto nell’email di conferma o nei promemoria. La cancellazione è definitiva. Lo stesso link permette di aggiornare le note e, fino a 24 ore prima, di scegliere qualsiasi orario disponibile dello stesso giorno. Per cambiare data o numero di ospiti occorre contattare il ristorante.',
  ...
  en: {
    seoTitle: 'Legal notice and booking terms', description: 'Restaurant operator details, website credits and online booking terms for Al Gobbo di Rialto.', kicker: 'Transparency · Company information', title: 'Legal notice and booking terms', updated: 'Last updated: 3 September 2026',
    ...
    cancellationTitle: 'Cancellations and changes', cancellationText: 'A booking may be cancelled free of charge before its scheduled time through the personal link in the confirmation email or reminders. Cancellation is final. The same link lets you update notes and, until 24 hours before the booking, choose any available time on the same day. Contact the restaurant to change the date or party size.',
  ...
  fr: {
    seoTitle: 'Mentions légales et conditions de réservation', description: 'Informations sur l’exploitant, crédits du site et conditions de réservation en ligne d’Al Gobbo di Rialto.', kicker: 'Transparence · Informations sur l’entreprise', title: 'Mentions légales et conditions de réservation', updated: 'Dernière mise à jour : 3 septembre 2026',
    ...
    cancellationTitle: 'Annulations et modifications', cancellationText: 'La réservation peut être annulée gratuitement avant l’heure prévue via le lien personnel reçu par e-mail ou dans les rappels. L’annulation est définitive. Le même lien permet de modifier les notes et, jusqu’à 24 heures avant la réservation, de choisir n’importe quel horaire disponible le même jour. Contactez le restaurant pour changer la date ou le nombre de personnes.',
  ...
  de: {
    seoTitle: 'Impressum und Reservierungsbedingungen', description: 'Betreiberdaten, Website-Credits und Bedingungen der Online-Reservierung von Al Gobbo di Rialto.', kicker: 'Transparenz · Unternehmensangaben', title: 'Impressum und Reservierungsbedingungen', updated: 'Letzte Aktualisierung: 3. September 2026',
  ...
  es: {
    seoTitle: 'Aviso legal y condiciones de reserva', description: 'Datos del operador, créditos del sitio y condiciones de reserva en línea de Al Gobbo di Rialto.', kicker: 'Transparencia · Información empresarial', title: 'Aviso legal y condiciones de reserva', updated: 'Última actualización: 3 de septiembre de 2026',
