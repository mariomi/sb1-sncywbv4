...
const legalCopy: Record<Language, LegalCopy> = {
  it: {
    ...
    cancellationText: 'La prenotazione può essere cancellata gratuitamente, prima dell’orario prenotato, tramite il link personale ricevuto nell’email di conferma o nei promemoria. La cancellazione è definitiva. Per modificare data, orario o numero di ospiti occorre contattare il ristorante.',
  ...
  en: {
    ...
    cancellationTitle: 'Cancellations and changes', cancellationText: 'A booking may be cancelled free of charge before its scheduled time through the personal link in the confirmation email or reminders. Cancellation is final. Contact the restaurant to change the date, time or party size.',
  ...
  fr: {
    ...
    cancellationTitle: 'Annulations et modifications', cancellationText: 'La réservation peut être annulée gratuitement avant l’heure prévue via le lien personnel reçu par e-mail ou dans les rappels. L’annulation est définitive. Contactez le restaurant pour modifier la date, l’heure ou le nombre de personnes.',
