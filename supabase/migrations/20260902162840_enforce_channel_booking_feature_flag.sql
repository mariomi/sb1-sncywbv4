-- Route channel-aware bookings through the public RPC that enforces the
-- online_reservations feature flag. This keeps consent recording atomic while
-- preventing direct calls to the WhatsApp-capable wrapper from bypassing the
